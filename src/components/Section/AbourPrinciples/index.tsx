...
const AboutPrinciples = () => {
  return (
    <div className="block w-full overflow-hidden">
      ...
      <div className="grid grid-cols-4 gap-[24px] mt-32">
        <div className="block font-barlowcondensed">
          <h6 className="font-bold text-18 tracking-[-0.02em] leading-[22px] mb-12">
            Our Vision
          </h6>
          <p className="text-18 leading-[127%]">
      ...
      <p className="block font-barlowcondensed text-24 leading-[127%] mt-32">
